...
namespace Project.V1.Web.Pages.EquipmnentOrdering.Components
{
    public partial class BreadcrumbOrdering
    {
        ...
        {
            if (!await UserAuth.IsAuthenticatedAsync() || !await UserAuth.IsAutorizedForAsync("Equipment Ordering"))
            {
