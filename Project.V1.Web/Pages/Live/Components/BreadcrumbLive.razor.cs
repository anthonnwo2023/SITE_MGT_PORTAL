...
namespace Project.V1.Web.Pages.Live.Components
{
    public partial class BreadcrumbLive
    {
        ...
        {
            if (!await UserAuth.IsAuthenticatedAsync() || !await UserAuth.IsAutorizedForAsync("Live Site"))
            {
