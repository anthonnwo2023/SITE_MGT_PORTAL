...
namespace Project.V1.Web.Pages.EquipmentMatching.Components
{
    public partial class BreadcrumbMatching
    {
        ...
        {
            if (!await UserAuth.IsAuthenticatedAsync() || !await UserAuth.IsAutorizedForAsync("Equipment Matching"))
            {
