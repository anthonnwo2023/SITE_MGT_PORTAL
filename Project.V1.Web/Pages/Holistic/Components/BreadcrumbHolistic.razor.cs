...
namespace Project.V1.Web.Pages.Holistic.Components
{
    public partial class BreadcrumbHolistic
    {
        ...
        {
            if (!await UserAuth.IsAuthenticatedAsync() || !await UserAuth.IsAutorizedForAsync("Holistic Site"))
            {
