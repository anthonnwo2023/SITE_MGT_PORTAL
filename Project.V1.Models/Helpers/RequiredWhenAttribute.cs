...
namespace Project.V1.Models.Helpers
{
    ...
    public class RequiredWhenAttribute : ValidationAttribute, IClientModelValidator
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (field != null)
            {
                ...
                if (dependentValue != null && dependentValue is string dependenV)
                {
                    dependentValue = dependenV.Trim();

                    if (!AllowEmptyStrings && dependenV.Length == 0)
                    {
                        dependentValue = null;
                    }
                }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-otherval", (string)TargetValue);
