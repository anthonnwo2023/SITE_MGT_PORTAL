...
namespace Project.V1.Data.Migrations
{
    ...
    [Migration("20211018001433_Initial-Commit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.V1.Models.ActionReason", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("NVARCHAR2(450)");
                    ...
                    b.Property<string>("RequestViewModelId")
                        .HasColumnType("NVARCHAR2(450)");

                    b.HasKey("Id");

                    b.HasIndex("RequestViewModelId");

                    b.ToTable("TBL_RFACCEPT_REQUEST_ACTIONCOMMENTS");
                });
            ...
            modelBuilder.Entity("Project.V1.Models.AntennaTypeModel", b =>
                {
                    ...
                    b.ToTable("TBL_RFACCEPT_ANTENNAS");
                });
            ...
            modelBuilder.Entity("Project.V1.Models.ActionReason", b =>
                {
                    b.HasOne("Project.V1.Models.RequestViewModel", null)
                        .WithMany("ActionReasons")
                        .HasForeignKey("RequestViewModelId");
                });
