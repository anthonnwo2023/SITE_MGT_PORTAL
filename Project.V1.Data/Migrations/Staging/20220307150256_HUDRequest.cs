        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestType = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SiteHaltRequestsId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    TechTypesId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBL_RFHUD_REQUESTS_TECH", x => new { x.SiteHaltRequestsId, x.TechTypesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_TBL_RFHUD_REQUESTS_TECH_TBL_RFHUD_REQUESTS_SiteHaltRequestsId",
                        column: x => x.SiteHaltRequestsId,
